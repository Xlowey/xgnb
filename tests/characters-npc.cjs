...
try{
 ...
 st.flags=Object.assign({},st.flags,{scene03Seen:true,hasKey:true});
 ...
 ck('the NPC is placed in the corridor before the scene-04 conversation',placed.place===true&&placed.room==='corridor',placed);
