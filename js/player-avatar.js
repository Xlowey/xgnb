(function () {
  ...
  sheet.src=window.MuseumAssets ? window.MuseumAssets.url("hero-walk-cycle.webp","characters") : new URL("../assets/images/characters/walk/hero-walk-cycle.webp",document.currentScript.src).href;
  ...
  var roomHeights=Object.freeze({
    ...
    // 所以早先按画面比例取的是 26，并注明「48 会让角色比走廊还高、看起来在穿墙」。
    // 2026-09-20 按需求改成 52（原值 +100%）：这是**明知代价仍调大**的决定——
    // 如果看下来觉得在走廊里穿墙，把 52 改回 26 即可，其余房间不受影响。
    museum:52,       // Overview corridors are ~24-30px wide in the artwork. Deliberately oversized on request (2026-09-20).
