...
(function () {
  ...
  scenes["scene-03"].events = [
    ...
    { type: "television", background: room, action: "打开电视" }
  ];
  ...
  scenes["tv-inspect"] = {id:"tv-inspect",title:"电视",location:"员工宿舍",theme:"dorm",events:[{type:"television",background:room}],lines:[],returnToMap:true};
