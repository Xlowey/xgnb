 ...
 *
 * 012 §5.1 那条铁律（买任何系统商品 = 选择系统 = 结局 A）现在**没有实现**：
 * 它要挂在「**第二十九场**」——最终抉择的三选一就在那里，结局 A 那句「系统，请将全部
 * 生存点兑换为战斗技能」也在那里（2026-09-19 按 009 原文更正，此前误记第二十八场；
 * 第二十八场只是 BOSS 发起攻击、赵灵挡下致命一击）。还要区分"买"和"装上"（装上属于
 * 玩法类道具的装备系统，还没做）。不过 state.shopOwned 已经把所有购买都记下了，
 * 接的时候直接读它就行。
 */
(function () {
  "use strict";
